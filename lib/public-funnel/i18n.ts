...
export type FunnelCopy = {
  ...
  consult: { title: string; metaTitle: string; metaDescription: string; solves: string; notSolves: string; youProvide: string; steps: string[]; riskHandling: string; report: string; humanReview: string; privacy: string; start: string; preparing: string };
...
const en: FunnelCopy = {
  ...
  consult: { title: "AI Health Consultation", metaTitle: "AI Health Consultation", metaDescription: "Start a structured, educational AI health consultation that helps organize your health questions and understand when to seek professional care. It is not a medical diagnosis, prescription, or individual treatment decision.", solves: "What this helps with", notSolves: "What this cannot do", youProvide: "What you provide", steps: ["Basic info", "Current health concern", "Health background", "Risk check", "Report or follow-up"], riskHandling: "How danger signals are handled", report: "Report format", humanReview: "Human review", privacy: "Data & privacy", start: "Start consultation", preparing: "Consultation service is being prepared" },
...
const zh: FunnelCopy = {
  ...
  consult: { title: "AI 健康问诊", metaTitle: "AI 健康问诊", metaDescription: "开始结构化、以健康科普为目的的 AI 健康问诊，帮助你整理健康问题并了解何时应寻求专业医疗。它不是医学诊断、处方或个体化治疗决策。", solves: "服务能解决什么", notSolves: "服务不能解决什么", youProvide: "你需要提供的信息", steps: ["基础信息", "当前健康问题", "健康背景", "风险检查", "报告或后续服务"], riskHandling: "危险信号处理方式", report: "报告形式", humanReview: "人工复核", privacy: "数据与隐私", start: "开始问诊", preparing: "问诊服务准备中" },
